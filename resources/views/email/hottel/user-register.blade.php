...
<head>
    ...
    <title>Welcome to BadrinathHotels.com – Your Journey Starts Here!</title>
    ...
    <div class="email-container" style="font-family: Helvetica, Arial, sans-serif;  width: 100%; max-width:600px; margin: 0px auto; padding: 0px 0px; border: 1px solid #EEEEEE; background:#fff;">
        ...
        <div class="box" style="font-family: Helvetica, Arial, sans-serif;  border: 1px solid #EEEEEE; background:#fff; margin:5px; padding:20px 20px; border-radius:5px; box-shadow: rgba(99, 99, 99, 0.1) 0px 2px 4px 0px; border: 1px solid #EEEEEE; background:#fff!important;">
            ...
            <div class="content">
                ...
                <p style="font-size:24px; color:#05264E; line-height:1.4;">Welcome to <b style="font-weight:700; color:#FF541E;">BadrinathHotels.com</b></p>
                ...
                <div style="font-family: Helvetica, Arial, sans-serif; margin:20px 0px; 0px 0px; padding-bottom:25px; display:block; border-bottom:1px solid #EEEEEE;">
                    <div style="font-family: Helvetica, Arial, sans-serif; margin-top:20px;">
                        <a href="https://badrinathhotels.com/" target="_blank" style="font-size:14px; font-family: Helvetica, Arial, sans-serif; display:inline-block; text-decoration:none; color:#fff; padding:10px 20px; background:#FF541E; border-radius:5px;" title="Login  to continue">Login  to continue</a>
                    </div>
                </div>
                ...
                <ul style="font-family: Helvetica, Arial, sans-serif;  margin:0px; padding:0px 0px 10px 0px;">
                    ...
                    <li style="font-family: Helvetica, Arial, sans-serif;  margin:0px; padding:0px 0px 15px 0px;color:#78828D; font-size:14px; font-weight:400; list-style:none;">Thank you for being a part of <a style="color:#78828D; text-decoration:none" href="https://badrinathhotels.com/">BadrinathHotels</a></li>
                </ul>
        ...
        <div>
            <div style="font-family: Helvetica, Arial, sans-serif;  text-align:center; color:#666; font-size: 12px; margin-top: 10px; padding-top:10px; padding-bottom:20px;">
                <div>
                    <a href="https://badrinathhotels.com/terms-and-conditions" style="font-family: Helvetica, Arial, sans-serif;  color:#3B4C65; margin: 0 5px;  display: inline-block;font-size:14px; font-weight:600; text-decoration:underline;">Terms and Conditions</a>&nbsp; &nbsp;<a href="https://badrinathhotels.in/privacy-policy" style="font-family: Helvetica, Arial, sans-serif;  color:#3B4C65; font-size:14px; font-weight:600; text-decoration:underline;">Privacy Policy</a>
