...
<head>
    ...
    <title>BadrinathHotels - Your Booking Status is Pending!</title>
        ...
        <div class="box" style="font-family: Helvetica, Arial, sans-serif; border: 1px solid #EEEEEE; margin:5px; padding:20px 20px; border-radius:5px; box-shadow: rgba(99, 99, 99, 0.1) 0px 2px 4px 0px; border: 1px solid #EEEEEE; background:#fff!important;">
            ...
            <div class="content">
                ...
                <p style="color:#05264E;font-family: Helvetica, Arial, sans-serif; font-size:14px; font-weight:500; margin-top:20px;">
                    Your payment has been received, and we’re currently processing your reservation.
                </p>
                ...
                <p  style="font-family: Helvetica, Arial, sans-serif;  margin:0px; padding:0px 0px 15px 0px;color:#78828D; font-size:14px;  margin-top:25px;">
                    Thank you for your patience! Our team will connect with you within one hour.
                </p>
                <p  style="font-family: Helvetica, Arial, sans-serif;  margin:0px; padding:0px 0px 15px 0px;color:#78828D; font-size:14px;  margin-top:25px;">
                    If your selected option is unavailable, we’ll provide alternatives or process your refund within 3-4 working days.
                </p>
                <p style="color:#05264E;font-family: Helvetica, Arial, sans-serif; font-size:14px; font-weight:500; margin-top:20px;" align="justify">
                    <b style="padding-right:5px;">Thank you for choosing BadrinathHotels.com. We look forward to hosting you soon!</b>
                </p>
                ...
                <div style="border-top:1px solid #EEEEEE;">
                    <p  style="font-family: Helvetica, Arial, sans-serif; margin:15px 0px 0px 0px; color:#78828D; font-size:14px;" align="justify">
                        This is an automatically generated email; For assistance, contact our support team using the details above.
                    </p>
                </div>
            </div>
