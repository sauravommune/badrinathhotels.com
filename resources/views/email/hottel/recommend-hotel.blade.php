    ...
    <div class="email-container" style="font-family: Helvetica, Arial, sans-serif;  width: 100%; max-width:600px; margin: 0px auto; padding: 0px 0px; border: 1px solid #EEEEEE; background:#fff;">
        ...
        <div class="box" style="font-family: Helvetica, Arial, sans-serif;  border: 1px solid #EEEEEE; background:#fff; margin:5px; padding:20px 20px; border-radius:5px; box-shadow: rgba(99, 99, 99, 0.1) 0px 2px 4px 0px; border: 1px solid #EEEEEE; backgroud:#fff!important;">
            ...
            <div class="content">
                ...
                <p  style="font-size:14px; line-height:1.4; color:#3B4C65; font-weight:400; margin-top: :10px; font-family: Helvetica, Arial, sans-serif;">Thank you for choosing BadrinathHotels.com for your stay! We have curated alternate hotel options that we believe better suits your preferences.</p>
                                ...
                                @if($item?->recommendHotel?->amenities->count() > 0)
                                    @foreach($item->recommendHotel->amenities as $amenity)
                                        <li style="margin-left:0px;">
                                            ...
                                            {{-- <img src="https://badrinathhotels.in/assets/front/images/yellow-star.png" style="height:20px; width:20px; padding-right:5px"> <span style="color: #3E4C56; font-size:14px; font-weight:400;">{{ $amenity->amenityName?->name??"" }}</span> --}}
                                        </li>
                                    @endforeach
                                @endif
                                </ul>
                ...
                <ul style="font-family: Helvetica, Arial, sans-serif;  margin:0px; padding:0px 0px 10px 0px;">
                    ...
                    <li style="font-family: Helvetica, Arial, sans-serif;  margin:0px; padding:0px 0px 15px 0px; color:#1A1F24; font-size:14px; font-weight:700; list-style:none;">Thank you for choosing <a href="https://badrinathhotels.com/" target="_blank" style="color: #FF541E; text-decoration:none;">BadrinathHotels.com</a> for your stay!</li>
                </ul>
