...
<head>
    ...
    <title>Welcome to BadrinathHotels</title>
    ...
    <div class="email-container" style="font-family: Helvetica, Arial, sans-serif; width: 100%; max-width:600px; margin: 0px auto; padding: 0px 0px; border: 1px solid #EEEEEE; background:#fff;">
        ...
        <div class="box" style="font-family: Helvetica, Arial, sans-serif; border: 1px solid #EEEEEE; margin:5px; padding:20px 20px; border-radius:5px; box-shadow: rgba(99, 99, 99, 0.1) 0px 2px 4px 0px; border: 1px solid #EEEEEE; background:#fff!important;">
            ...
            <div class="content">
                ...
                <p style="font-size:24px; color:#05264E; line-height:1.4;">How was your <b style="font-weight:700;">experience booking a hotel with BadrinathHotels?</b></p>
                <p  style="font-size:14px; color:#3B4C65; font-weight:400; margin-top:10px; font-family: Helvetica, Arial, sans-serif; line-height:1.4;">We are eager to know about your recent experience with BadrinathHotels. Click here [google review link] or the button below to provide your feedback.</p>
                <div style="font-family: Helvetica, Arial, sans-serif; margin:20px 0px; 0px 0px; padding-bottom:25px; display:block; border-bottom:1px solid #EEEEEE;">
                    <div style="font-family: Helvetica, Arial, sans-serif; margin-top:20px;">
                        <a href="https://badrinathhotels.com/" target="_blank" style="font-size:14px; font-family: Helvetica, Arial, sans-serif; display:inline-block; text-decoration:none; color:#fff; padding:10px 20px; background:#FF541E; border-radius:30px;" title="Give Your Feedback">Give Your Feedback</a>
                    </div>
                </div>
                <ul style="font-family: Helvetica, Arial, sans-serif; margin:0px; padding:0px 0px 10px 0px;">
                    <li style="font-family: Helvetica, Arial, sans-serif; margin:0px; padding:15px 0px 15px 0px;color:#78828D; font-size:14px; font-weight:400; list-style:none;">Thank you for being a part of <a style="color:#78828D; text-decoration:none" href="https://badrinathhotels.com/">BadrinathHotels</a></li>
                </ul>
