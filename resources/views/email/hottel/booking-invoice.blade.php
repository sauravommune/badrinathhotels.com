...
<head>
    ...
    <title>BadrinathHotels - Your Booking Invoice</title>
...
<body style="font-family: Helvetica, Arial, sans-serif; margin: 20px 0px; padding: 10px 10px; border: 0; background-color:#F3F2F1;">
    ...
    <div class="email-container" style="font-family: Helvetica, Arial, sans-serif; width: 100%; max-width:600px; margin: 0px auto; padding: 0px 0px; border: 1px solid #EEEEEE; background:#fff;">
        ...
        <div class="box" style="font-family: Helvetica, Arial, sans-serif; border: 1px solid #EEEEEE; margin:5px; padding:20px 20px; border-radius:5px; box-shadow: rgba(99, 99, 99, 0.1) 0px 2px 4px 0px; border: 1px solid #EEEEEE; background:#fff!important;">
            ...
            <div class="header">
                <img style="font-family: Helvetica, Arial, sans-serif; max-width: 200px;" src="{{ !empty($message) ? $message->embed(asset('assets/front/images/black-logo.png')) : asset('assets/front/images/black-logo.png') }}" alt="TourTripX Logo">
            </div>
            <div class="content">
                ...
                <p style="color:#05264E;font-family: Helvetica, Arial, sans-serif; font-size:14px; font-weight:500; margin-top:20px;">Greetings from BadrinathHotels!</p>
                <p style="font-size:24px; color:#05264E; line-height:1.4;">
                    Thank you for <b style="font-weight:700;">Booking</b> your <b style="font-weight:700;">Hotel</b> with BadrinathHotels!
                </p>

                <p  style="font-size:14px; line-height: 1.5; color:#3B4C65; font-weight:400; margin-top:10px; font-family: Helvetica, Arial, sans-serif; line-height:1.4;"> We have sent you a Receipt for your booking at <a href="{{ $booking?->hotel?->map_url }}"><strong>{{ $booking?->hotel?->name }}</strong></a> for the dates {{ formatDateMdY($booking?->check_in_date) }} {{ $booking->hotel?->check_in_time }} to {{ formatDateMdY($booking?->check_out_date) }} {{ $booking->hotel?->check_out_time }}.</p>
        ...
        @if( !empty($preview) && $preview == 'true' )
            <a href="{{ Route('download.invoice', encode($booking->id)) }}" style="background-color: #FF541E; color: #fff; border: none; padding: 10px 20px; border-radius: 5px;margin: 10px 0px;float: right; text-decoration: none;float: left; font-size: 13.3333px;">
                Download Receipt
            </a>
