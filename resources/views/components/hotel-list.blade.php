...
@if (count($hotelList) > 0)
    @if( $agent->isDesktop() )
        ...
        <style type="text/css">
         ...
         <h2 class="pb-1" style="font-size: 1em;line-height: 1.5;font-family: PlusJakartaSans-Regular;color: #1a1f24;">
            {{ count($hotelList) == 1 ? 'Found ' . count($hotelList) . ' Hotel in ' . $searchTerms->city?->name : ' Found ' . count($hotelList) . ' Hotels in ' . $searchTerms->city?->name }}
        </h2>
        @foreach ($hotelList as $hotel)

        @if((!empty($hotel['hotel']['hotelImg']['image']) && checkImageExists($hotel['hotel']['hotelImages'])) && (!empty($hotel['hotel']?->hotel_img) && checkImageExists($hotel['hotel']?->hotel_img)))
                                                        ...
                                                        <div class="d-flex align-items-center recommended-item">
                                                            <div class="recommended-icon">
                                                                <div class="inner-icon">
                                                                    <img src="{{ asset('assets/front/images/hand-icon.svg') }}" alt="Recommended" width="" height="">
                                                                </div>
                                                            </div>
                                                        ...
                                                        @if ($key < 3)
                                                            <div class="facilities-box">
                                                                <div class="icon d-flex">
                                                                    <span class="material-symbols-outlined fs-5 me-1">{{$amenity_name['icode']?? 'spa'}}</span>
                                                                ...
                                                                <div class="rating">
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div class="reviews ps-1">
                                                                            <div class="d-flex align-items-center">
                                                                                <div class="reviews-text">based on {{$hotel['hotel']['google_rating_total']??0}} reviews</div>
                                                                            </div>
                                                                        </div>
                                                                        @endif
                                                                    </div>
                                    ...
                                    <div class="col-4 ">
                                        <div class="content-right">
                                            ...
                                            @endphp
                                                ...
                                                <div class="star-rating">
                                                    ...
                                                    <div class="d-flex gap-1 align-items-center">
                                                        <div class="rating-star">
                                                            <p><b>{{$rating}}</b><span class="bi bi-star-fill text-warning fs-8 ps-1 pe-2"></span><b>{{$html}}</b> </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                @endif
                                                ...
                                                @endphp
                                                <div class="box-32 parking {{ $parkingClass }}"  data-bs-toggle="tooltip"  data-bs-placement="top"  title="{{ $available }}">
    ...
    @else
        ...
        <div class="col-12">
            ...
            @if((!empty($hotel['hotel']['hotelImg']['image']) && checkImageExists($hotel['hotel']['hotelImages'])) && (!empty($hotel['hotel']?->hotel_img) && checkImageExists($hotel['hotel']?->hotel_img)))
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mt-2 @if ($hotel['hotel']?->room?->sold_out == '0') disabled-div @endif">
                    {{-- <a href="{{ route('hotel.details', ['slug' => $hotel['hotel']['slug'], 'searchId' => encode($searchTerms->id)]) }}"> --}}
                        <a href="{{ route('hotel.details', $hotel['hotel']['slug']) }}/">
                                                    ...
                                                    <div class="star-rating">
                                                        ...
                                                        <div class="d-flex gap-1 align-items-center">
                                                            <div class="rating-star pt-1">
                                                                <p><b>{{ $rating }}</b><span class="bi bi-star-fill text-warning rated ps-1 pe-2"></span>{{ $html }}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    @endif
                                                    ...
                                                    <div class="result-box-container-right pt-0 mt-0">
                                                        <div class="md-hotel-info w-100 mt-1">
                                                            <div class="row justify-content-xl-between g-0">
                                                                <div class="col-6 col-sm-12 col-md-6 col-lg-6 col-xl-3">
                                                                ...
                                                                <div class="col-6 col-sm-12 col-md-6 col-lg-6 col-xl-9 ">
                                                                    <div>
                                                                       
                                                                        <div class="content-md-right p-0 m-0 gap-0">
                                                                            <div class="price-rate">
                                                                                <div class="price-rate">
                                                                                    @php
                                                                                        $roomCount = $searchTerms->roomCount??1;
                                                                                        $per_night_price = ($hotel['per_night_price'] ?? 0) * $roomCount;
                                                                                    @endphp
                                                                                    <div class="price-cut mt-0">
                                                                                        <div class="price-night mb-2">
                                                                                            <h4 class="mb-2 text-end"> ₹ {{ $per_night_price}} </h4>
                                                                                            <p class="text-end">Per night for <strong>{{ $roomCount }}</strong> {{roomText($roomCount)}}</p>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="rest-detials">
                                                                            ...
                                                                            <div class="d-flex align-items-center">
                                                                                ...
                                                                                <div class="ms-2 ">
                                                                                    ...
                                                                                    <div class="d-flex align-items-center">
                                                                                        ...
                                                                                        <div class="reviews ">
                                                                                            <div class="d-flex align-items-center">
                                                                                                <div class="reviews-text ps-2">based on {{$hotel['hotel']['google_rating_total']??0}} reviews</div>
                                                                                            </div>
                                                                                        </div>
                                                                                        @endif
                                                                                    </div>
