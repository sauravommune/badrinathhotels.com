                                    ...
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-4 commmon-box">
                                        <div class="d-flex justify-content-center align-items-center info-box">
                                            <div class="d-flex flex-column align-items-center border-right">
                                                ...
                                                <a href="mailto:{{ config('contact-info.email') }}"
                                                    class="text-center">{{ config('contact-info.email') }}</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-4 commmon-box">
                                    ...
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-4 commmon-box">
                                        <div class="d-flex justify-content-center align-items-center info-box">
                                            <div class="d-flex flex-column align-items-center border-right">
                                                ...
                                                <a href="tel:{{ config('contact-info.mobile_number') }}"
                                                    class="text-center">+91
                                ...
                                <div class="accordion accordion-flush" id="accordionFlushExample">
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="flush-headingOne">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                1. How do I create an account on BadrinathHotels.com?
                                            </button>
                                        </h2>
                                        <div id="flush-collapseOne" class="accordion-collapse collapse"
                                            aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                <p>Click on the 'Sign Up' button on our homepage and fill in the
                                                    required details.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <p>Use the 'Forgot Password' option on the login page and follow the
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="flush-headingTwenty">
                                            <button class="accordion-button collapsed" type="button"
                                                data-bs-toggle="collapse" data-bs-target="#flush-collapseTwenty"
                                                aria-expanded="false" aria-controls="flush-collapseTwenty">
                                               3. Can I view my booking history?
                                            </button>
                                        </h2>
                                        <div id="flush-collapseTwenty" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <p>Yes, log in to your account and navigate to the 'My Bookings'
                                                    section.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="flush-headingTwentyOne">
                                            <button class="accordion-button collapsed" type="button"
                                                data-bs-toggle="collapse" data-bs-target="#flush-collapseTwentyOne"
                                                aria-expanded="false" aria-controls="flush-collapseTwentyOne">
                                                4. How do I update my account details?
                                            </button>
                                        </h2>
                                        <div id="flush-collapseTwentyOne" class="accordion-collapse collapse"
                                            aria-labelledby="flush-headingTwentyOne"
                                            data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                <p>Go to 'Account Settings' after logging in and edit your details.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="flush-headingThree">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                5. Is my personal information secure on BadrinathHotels.com?
                                            </button>
                                        </h2>
                                        <div id="flush-collapseThree" class="accordion-collapse collapse"
                                            ...
                                            data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                <p>Absolutely! We use advanced encryption protocols to keep your data
                                                    safe and secure.</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="accordion accordion-flush" id="accordionFlushExampleTwo">
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseFour" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <p>You can check room availability by visiting our website, entering
                                                    your desired dates, and viewing available options. Alternatively,
                                                    you can contact our reservations team directly by phone or email.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseFive" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                ...
                                                <p class="pb-3">Check our website or contact us for detailed
                                                    descriptions and features.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseSix" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                ...
                                                <p>Some room types may also include additional amenities such as
                                                    minibars, balconies, or kitchenettes.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseTwelve" class="accordion-collapse collapse"
                                            ...
                                            data-bs-parent="#accordionFlushExampleTwo">
                                            <div class="accordion-body">
                                                <p class="pb-3">Yes, you can make special requests (e.g., a room with a
                                                    sea view or on a higher floor) during the booking process. While we
                                                    cannot guarantee these requests, we will do our best to accommodate
                                                    them.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseThirteen" class="accordion-collapse collapse"
                                            ...
                                            data-bs-parent="#accordionFlushExampleTwo">
                                            <div class="accordion-body">
                                                <p class="pb-3">Yes, we provide discounted rates for group bookings.
                                                    Contact our reservations team with your group details, and we’ll be
                                                    happy to assist.</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="accordion accordion-flush" id="accordionFlushExampleThree">
                                        ...
                                        <div id="flush-collapseSeven" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <ul>
                                                    ...
                                                    <li class="pb-2">Credit/Debit Cards: Visa, MasterCard, American
                                                        Express, and Discover</li>
                                                    <li class="pb-2">Online Payments: PayPal, Apple Pay, Google Pay</li>
                                                    <li class="pb-2">Bank Transfers: For direct bookings (details
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseEight" class="accordion-collapse collapse"
                                            ...
                                            data-bs-parent="#accordionFlushExampleThree">
                                            <div class="accordion-body">
                                                <p>Yes, we offer secure online payment options during the booking
                                                    process. You can pay using a credit/debit card, PayPal, or other
                                                    supported payment platforms.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseNine" class="accordion-collapse collapse"
                                            ...
                                            data-bs-parent="#accordionFlushExampleThree">
                                            <div class="accordion-body">
                                                <p>Yes, we accept major international credit cards and payment platforms
                                                    like PayPal. If you have specific payment needs, please contact us
                                                    in advance.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseTen" class="accordion-collapse collapse"
                                            ...
                                            data-bs-parent="#accordionFlushExampleThree">
                                            <div class="accordion-body">
                                                <p>Yes, you can choose to pay at the hotel during check-in. However, a
                                                    credit card may be required to guarantee your booking.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseEleven" class="accordion-collapse collapse"
                                            ...
                                            data-bs-parent="#accordionFlushExampleThree">
                                            <div class="accordion-body">
                                                <p>We do not charge additional fees for using credit cards or digital
                                                    payment methods. However, your bank or payment provider may apply
                                                    foreign transaction fees or other charges.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
