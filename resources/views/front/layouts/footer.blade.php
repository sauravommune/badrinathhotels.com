                            ...
                            <div class="col-md-12">
                                <div class="modal-inner">
                                    <div class="logo text-center mb-3">
                                        <img decoding="async"
                                            data-src="{{ asset('assets/front/images/Badrinath-hotel-Icon-Blk.webp') }}" class="lazy"
            ...
            <div class="col-lg-12 col-xl-2 mb-4">
                <div class="d-xl-block me-4">
                    <div class="footer-logo pb-4">
                        <img decoding="async" class="lazy" src="{{ asset('assets/front/images/Badrinath-hotel-Icon-Blk.webp') }}"
