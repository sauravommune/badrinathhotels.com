    ...
    <nav class="navbar navbar-expand-xl {{ Route::is('home') ? '' : 'dark-bg-back' }} {{ (Route::current()->getName() == 'searchResultCity' || Route::current()->getName() == 'searchResult') ? 'position-class' : '' }}" id="navbar">
        <div class="container">
            <a class="navbar-brand" href="{{route('home')}}">
                <img decoding="async" class="d-none" src="{{ asset('assets/front/images/Badrinath-hotel-Icon-Blk.webp') }}" loading="lazy" alt="Logo" style="width:110px !important;" id="black-logo" />
                <img decoding="async" class="" src="{{ asset('assets/front/images/Badrinath-hotel-Icon-WH.webp') }}" loading="lazy" alt="Logo" style="width:115px !important;" id="white-logo" />
            </a>
