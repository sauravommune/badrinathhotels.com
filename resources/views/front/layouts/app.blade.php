...
<html lang="en">
	<head>
		...
		})(window,document,'script','dataLayer','GTM-NV93FFFF');</script>
		...
		@else
			<title>{{ $meta['title']??'Find and Book the Best Badrinath Hotels on BadrinathHotels.com' }}</title>
			<meta name="description" content="{{$meta['description']??'Planning a trip to Badrinath? Discover and book top Badrinath Hotels online with BadrinathHotels.com – your one-stop destination for quality stays in Badrinath.'}}" />
		@endif
	...
	<body data-instant-intensity="mousedown">
		...
		<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NV93FFFF"
