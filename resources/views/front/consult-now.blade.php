    ...
    <div class="container py-xl-4 py-3">
        <div class="section-heading">
            ...
            <div class="section-para">
                At BadrinathHotels.com, we specialize in customized hotel booking solutions
            </div>
        </div>
                ...
                <div class="bg-white-section" id="testimonial-slider-II">
                    <div>
                        <div class="slider-section">
                            ...
                            <div class="content">
                                <p>BadrinathHotels.com made finding the perfect hotel so easy! The booking process was smooth, and the rates were unbeatable. My stay was comfortable and hassle-free!</p>
                            </div>
                    ...
                    <div>
                        <div class="slider-section">
                            ...
                            <div class="content">
                                <p>The wide variety of hotel options on BadrinathHotels.com amazed me. I found a luxurious hotel within my budget, and the customer support team ensured everything went perfectly!</p>
                            </div>
                            <div class="user-section">
                                <div class="d-flex align-items-center">
                                    <div class="image">
                    ...
                    <div>
                        <div class="slider-section">
                            ...
                            <div class="content">
                                <p>I always use BadrinathHotels.com for my business trips. The platform is user-friendly, and the detailed reviews helped me choose the right hotel every time. Highly recommended!</p>
                            </div>
                            <div class="user-section">
                                <div class="d-flex align-items-center">
                                    <div class="image">
                    ...
                    <div>
                        <div class="slider-section">
                            ...
                            <div class="content">
                                <p>BadrinathHotels.com made my vacation planning stress-free. The site provided excellent deals on premium hotels, and I loved how accurate the descriptions and photos were!</p>
                            </div>
                            <div class="user-section">
                                <div class="d-flex align-items-center">
                                    <div class="image">
                    ...
                    <div>
                        <div class="slider-section">
                            ...
                            <div class="content">
                                <p>BadrinathHotels.com offers fantastic deals and exceptional customer service. I had a minor issue during check-in, but their team resolved it quickly. Will definitely book again!</p>
                            </div>
                            <div class="user-section">
                                <div class="d-flex align-items-center">
                                    <div class="image">
