...
@section('content')
                    ...
                    <div class="row">
                                                        ...
                                                        <div class="rating">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div>
                                                                    @php
                                                                        $rating =
                                                                            $hotelDetails['details']['google_rating'];
                                                                ...
                                                                @if ($hotelDetails['details']['google_rating_total'] > 0)
                                                                    <div class="reviews ps-1">
                                                                        <div class="d-flex align-items-center">
                                                                            <div class="reviews-text">based on
                                                                                {{ $hotelDetails['details']['google_rating_total'] ?? 0 }}
                                                                                reviews</div>
                                                                        </div>
                                                                    </div>
                                                                @endif
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="view-all">
                                                            <a href="#" data-bs-toggle="modal"
                                                                data-bs-target="#amenities">View All
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-3 left-item mt-xl-0 mt-4">
                            <div class="left-card">
                                <div class="title">
                                    <div class="row px-2">
                                        <div class="col-7 p-0">
                                            <h3>{{ ucwords($hotelDetails['details']['room']['roomType']['name']) ?? '' }}
                                            </h3>
                                            <ul>
                                                <li>
                                                    <span
                                                        class="icon-king-bed pe-1"></span>{{ $searchData->roomCount ?? 0 }}
                                                    {{ ucfirst(roomText($searchData->roomCount)) }}
                                                </li>
                                                <li class="px-1">|</li>
                                                <li>
                                                    <span
                                                        class="icon-user pe-1"></span>{{ $searchData->adultCount + $searchData->childCount ?? 0 }}
                                        ...
                                        <div class="col-5 p-0">
                                            <div
                                                class="d-flex justify-content-end justify-content-md-between w-100 flex-wrap gap-2">
                                                <div class="d-flex align-items-center">
                                                    <div class="p-btn">
                                                        @php
                                                            $parkingClass = '';
                                                            $available = '';
                                                            if (
                                                                $hotelDetails['details']['parking_available'] ===
                                                                'yes_free'
                                                            ) {
                                                                ...
                                                                $hotelDetails['details']['parking_available'] === 'no'
                                                            ) {
                                                        ...
                                                        <a href="javascript:void(0);"
                                                            class="btn small-btn {{ $parkingClass }}"
                                    ...
                                    <div class="price mt-3">
                                        <div>
                                            @php
                                                ...
                                                $per_night_price =
                                                    $per_night_price + $hotelDetails['extra_person_price'];
                                            ...
                                            <small>Per Night for {{ $roomCount }} {{ ucfirst(roomText($roomCount)) }}
                                            </small>
                                        </div>
                                    </div>
                                            ...
                                            @else
                                                <div>
                                                    <a href="{{ route('hotel.addDetails', ['hotelId' => encode($hotelDetails['details']['id']), 'roomId' => encode($hotelDetails['details']['room']['id']), 'roomTypeId' => encode($hotelDetails['details']['room']['roomType']['id']), 'searchId' => encode($searchData?->id)]) }}"
                                                        title="Book Now" class="btn btn-outline-primary"
                                                        id="reserve-button">Book Now</a>
                                                </div>
                                                <div class="ps-3">
                                                    <a href="#target_div"
                            ...
                            <div class="map-section mt-4">
                                <div class="image">
                                    ...
                                    @if ($hotelDetails['details']?->embed_map_url)
                                        <div>
                                            <iframe src="{{ $hotelDetails['details']?->embed_map_url ?? '' }}"
                                                class="w-100"></iframe>
                                    ...
                                    @if ($hotelDetails['details']?->map_url)
                                        <div class="title">
                                            <h4><a target="_blank"
                                                    href="{{ $hotelDetails['details']?->map_url ?? '' }}">View in Map</a>
                                            </h4>
                                        </div>
                                    @endif
                                </div>
                                ...
                                <div class="location-section mt-2 py-3 border-bottom">
                                    ...
                                    @if ($hotelDetails['details']->nearByPlace->count() > 5)
                                        <div class="text-start pt-2 ps-4">
                                            <a href="javascript:void(0);" data-bs-toggle="modal"
                                                data-bs-target="#nearest-location"
                            ...
                            @if ($hotelDetails['details']->video_title && $hotelDetails['details']->video_url)
                                <div class="video-wrapper ads-video my-2 pt-xl-0 pt-4">
                                    <div class="ads-video-container w-100">
                                        <h2 class="heading">{{ ucfirst($hotelDetails['details']->video_title ?? '') }}
                                        </h2>
                                        <div class="row">
                                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-9">
                                                <div class="yt-video">
                                                    <iframe src="{{ $hotelDetails['details']->video_url }}"
                                            ...
                                            <div class="col-3 d-none d-xl-block">
                                                <div class="ads-video-image position-relative">
                                                    <img src="{{ asset('assets/front/images/hotel-lock.png') }}"
                                                        alt="" class="" width="" height="" />
                                                    <a href="{{ url()->previous() }}"
                                                        class="btn btn-white  position-absolute bottom-0 start-50 translate-middle-x mb-4">Explore
                                                        Now</a>
                                                </div>
                            ...
                            <form class="filter-section mt-xl-4 mt-2" id="searchRoom" action="javascript:void(0)">
                                ...
                                <div class="row">
                                    <input type="hidden" name="hotel_id"
                                        value="{{ $hotelDetails['details']['id'] ?? '' }}">
                                    <input type="hidden" name="room_id"
                                        value="{{ $hotelDetails['details']['room']['id'] ?? '' }}">
                                    ...
                                    <div
                                        class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-4 repeat-section guest-select mb-xl-0 mb-4">
                                        <div class="input-box">
                                            <div class="search-item">
                                                <label for="exampleInputEmail1" class="form-label ">Rooms & Guests</label>
                                                <div class="dropdown-container">
                                                    <input type="text" class="guest-input pb-0" value="Select Guests"
                                                        readonly />
                                                    <div class="guest-dropdown dropdown">
                                                        <div class="guest-category">
                                                            ...
                                                            <div class="controls d-flex">
                                                                ...
                                                                <span
                                                                    class="room-count">{{ $searchData->roomCount ?? 1 }}</span>
                                                        ...
                                                        <div class="guest-category">
                                                            <span>Adults</span>
                                                            <div class="controls d-flex">
                                                                <a class="adult-decrement decrement"
                                                                    data-type="adult">-</a>
                                                                <span
                                                                    class="adult-count">{{ $searchData->adultCount ?? 1 }}</span>
                                                                <a class="adult-increment increment"
                                                                    data-type="adult">+</a>
                                                            </div>
                                                        </div>
                                                        <div class="guest-category">
                                                            <span>Children</span>
                                                            <div class="controls d-flex">
                                                                <a class="child-decrement decrement"
                                                                    data-type="child">-</a>
                                                                <span
                                                                    class="child-count">{{ $searchData->childCount ?? 0 }}</span>
                                                                <a class="child-increment increment"
                                                                    data-type="child">+</a>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="col  repeat-section mb-xl-0 mb-4 d-flex align-items-center">
                                        <div class="btn-box">
                                            <button class="btn btn-outline-primary" id="clickRoomSearch"
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-3 d-flex align-items-end">
                            <div class="guaranteed-hotel w-100">
                                <img data-src="{{ asset('assets/front/images/guaranteed-hotel-detail.jpg') }}"
                                    alt="" class="img-fluid lazy w-100 mt-3" />
                            </div>
                        </div>
                        <!-- end copied section -->
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-9  mt-xl-5 mt-2">
                            ...
                            <div class="room-skeleton-loading d-none" id="loaderImg">
                                <div class="row g-0">
                                    ...
                                    <div
                                        class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-5 d-flex align-items-center justify-content-center">
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-3  mt-xl-5 mt-2 section-card">
                            <div class="right-card-custom mb-xl-3 mb-3" id="hide-section">
                                <form action="{{ route('add_booking_multiple') }}" method="post">
                                    <input type="hidden" name="search_id" id ="append_search_id"
                                        value="{{ encode($searchData?->id) }}">
                                    @csrf()
                                    <div class="inner-wrapper">
                                        ...
                                        <div class="m-2">
                                            @if ($hotelDetails['details']?->sold_out == 1 || empty($allAvailableRoom))
                                                <div class="text-end">
                                                    <span class=" btn btn-outline-primary btn-block w-100 sold-out">Sold
                                                        Out</span>
                                                </div>
                                            @else
                                                <div class="my-2">
                                                    <button class="btn btn-outline-primary btn-block w-100">Book
                                                        Now</button>
                                                </div>
                                            @endif
                                        </div>
                ...
                <div class="row main-section-10">
                    <div class="col-12">
                        <div class="section-title">
                            <h4 class="title p-0">Google Reviews of {{ ucwords($hotelDetails['details']?->name) ?? '' }}
                            </h4>
                        </div>
                    </div>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="image">
                                                            @if ($review->review_profile_photo && file_exists(storage_path('app/public/' . $review->review_profile_photo)))
                                                                <img src="{{ asset('storage/' . $review->review_profile_photo) }}"
                                                                    alt="" width="40" title="User Image" />
                                                            @else
                                                        ...
                                                        <div class="title ps-2">
                                                            <h3 class="mb-0 pb-0">
                                                                {{ ucwords($review?->author_name ?? '') }}</h3>
                                                            @if ($review?->date)
                                                                <p class="mb-0 pb-0">
                                                                    {{ $review?->date ? \Carbon\Carbon::parse($review->date)->format('M jS, Y') : '' }}
                                                                </p>
                                                            @endif
                                                        </div>
                                                    ...
                                                    <div class="text-section">
                                                        <div class="content mx-1">
                                                            ...
                                                            @if (strlen($review?->text ?? '') > 100)
                                                                <a href="javascript:void(0);"
                                                                    class="read-more-toggle">Read More</a>
                                                            @endif
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <div class="section-title">
                        ...
                        <div class="d-flex">
                            <div class="check-in-text">
                                ...
                                <b>Check-in :</b><span
                                    class="ps-1">{{ $hotelDetails['details']['check_in_time'] ?? '' }}
                                    PM</span>
                            </div>
                            <div class="check-in-text ps-3">
                                <b>Check-out :</b><span
                                    class="ps-1">{{ $hotelDetails['details']['check_out_time'] ?? '' }}
                                    AM</span>
                            </div>
                        </div>
    ...
    <div class="modal fade hotel-amenities" id="amenities" data-bs-backdrop="static" data-bs-keyboard="false"
                            ...
                            <ul class="list-unstyled mt-3 mb-0">
                                @foreach ($hotelDetails['details']['amenities'] as $amenity)
                                    <li class="d-flex align-items-center mb-1">
                                        <span
                                            class="material-symbols-outlined fs-5 me-2">{{ $amenity['amenityName']['icode'] ?? 'spa' }}</span>
                        ...
                        @foreach ($hotelDetails['details']['hotelImages'] as $key => $hotelImg)
                            <div class="col-12 col-sm-6 col-md-3 col-xl-3 ">
                                <div class="thumbnail-gallery">
                                    <a href="javascript:void(0);" data-bs-target="#exampleModalToggle3"
                ...
                setTimeout(function() {
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            $('#append_search_id').val(response
                                .searchId); // Append Search Id
