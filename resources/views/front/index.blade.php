...
<section class="section-1 lazy d-flex align-items-center bg-image-style " data-bg="{{ asset('assets/front/images/hotels-in-badrinath.webp') }}" id="book">
    <div class="container d-none d-sm-none d-md-none d-lg-none d-xl-block">
        <div class="row">
            <div class="col-12 col-xl-7 position-relative header-title">
                <h1 class="fs-5">Book Badrinath Hotels at Best Prices</h1>
            ...
            <div class="col-12">
                <div class="d-xl-flex justify-content-xl-between align-items-xl-center w-100">
                    <div class="section-title">
                        <h2>Discover the Divine Beauty of Badrinath with Hottel</h2>
                        <p>Hottel - Unveil the Sacred Charm of Badrinath with Hottel</p>
                    </div>
                    ...
                    <div class="main-box">
                        <a href="javascript:void(0);">
                            <div class="image bg-image-style lazy"
                                data-bg="{{ asset('assets/front/images/badrinath-ji-temple.webp') }}"></div>
                            <div class="content mb-0 pb-0">
                                <h3>Shri Badrinath Ji Temple</h3>
                                <p class="mb-0">It is a Religious Shrine of Lord Vishnu & One of Most Religious Pilgrimage in Char Dham Yatra.</p>
                            </div>
                        </a>
                    </div>
                    <div class="main-box">
                        <a href="javascript:void(0);">
                            <div class="image bg-image-style lazy"
                                data-bg="{{ asset('assets/front/images/Saraswati.webp') }}"></div>
                            <div class="content mb-0 pb-0">
                                <h3>Saraswati River</h3>
                                <p class="mb-0">The Saraswati River, a significant water body in Hindu mythology and history, is believed to have been a large river that flowed through northern India.</p>
                            </div>
                        </a>
                    </div>
                    <div class="main-box">
                        <a href="javascript:void(0);">
                            <div class="image bg-image-style lazy"
                                data-bg="{{ asset('assets/front/images/Vasudhara.webp') }}"></div>
                            <div class="content mb-0 pb-0">
                                <h3>Vasudhara Falls</h3>
                                <p class="mb-0">Vasudhara Falls is a stunning waterfall near Badrinath in Uttarakhand, India.</p>
                            </div>
                        </a>
                    </div>
                    <div class="main-box">
                        <a href="javascript:void(0);">
                            <div class="image bg-image-style lazy"
                                data-bg="{{ asset('assets/front/images/Bheem.jpg') }}"></div>
                            <div class="content mb-0 pb-0">
                                <h3>Bheem Pul</h3>
                                <p class="mb-0">Bheem Pul is located in Mana, the last village located on the border with Tibet. It is 3 km from Badrinath and is built over Saraswati River.</p>
                            </div>
                        </a>
                    </div>
                    <div class="main-box">
                        <a href="javascript:void(0);">
                            <div class="image bg-image-style lazy"
                                data-bg="{{ asset('assets/front/images/Brahma.jpg') }}"></div>
                            <div class="content mb-0 pb-0">
                                <h3>Brahma Kapal</h3>
                                <p class="mb-0">Brahma Kapal is a place in Badrinath which is of great importance for Hindus.</p>
                            </div>
                        </a>
                    </div>
                    <div class="main-box">
                        <a href="javascript:void(0);">
                            <div class="image bg-image-style lazy"
                                data-bg="{{ asset('assets/front/images/narad-kunda.jpg') }}"></div>
                            <div class="content mb-0 pb-0">
                                <h3>Narada Kund</h3>
                                <p class="mb-0">Narada Kund is a natural thermal spring in Badrinath, Uttarakhand, India, known for its hot, sulfurous waters.</p>
                            </div>
                        </a>
                    </div>
                </div>
...
<section class="section-5 my-xl-4 my-3">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="image bg-image-style lazy" data-bg="{{ asset('assets/front/images/hotels-in-badrinath-1.webp') }}">
                    <div class="content">
                        <div>
                            <div class="short-logo">
                                <img decoding="async"  class="lazy" data-src="{{ asset('assets/front/images/Badrinath-hotel-Icon-WH.webp') }}" width="150"
                                    height="" alt="" />
                            </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="d-xl-flex justify-content-between align-items-xl-center w-100">
                                <div class="section-title">
                                    <h2>Stay at the Top Hotels in Badrinath</h2>
                                    {{-- <p>Experience the Comfort of Varanasi’s Most Popular Hotels – Handpicked for You!  {{$popularHotel['0']->cityName->state->name??''}}</p> --}}
                                    <p>Experience the Comfort of Badrinath Most Popular Hotels – Handpicked for You!</p>
                                </div>
                                <!-- <div class="pt-xl-0 pt-3">
                                    <a href="#" title="View All" class="btn btn-primary">View All</a>
                                </div> -->
...
<section class="section-8 lazy bg-image-style section-8-II" data-bg="{{ asset('assets/front/images/hotels-in-badrinath-2.webp') }}">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="section-title">
